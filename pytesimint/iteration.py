...
# def original_iter_func(initial_temps,
#                        initial_diffs,
...
#                        Nx, Ny, Nz,
#                        dt):
#     # full_soln = np.zeros_like(blank_vol)
#     full_soln = initial_temps
#     # print(full_soln)
#     # print("***")

#     # just going to run for 2 iterations
#     for h in range(4):
...
#                     else:
#                         pass
#         r_values = dm.initialise_r_vector(dt, dx, initial_diffs)
#         # print(f"{h}/100")
#         for j in range(len(y)):
#             for k in range(len(z)):
#                 # print(f"diffs[:,{j},{k}] = {initial_diffs[:, j, k]}")
#                 temps = full_soln[:, j, k]
...
#                  main_diag_B,
#                  upper_diag_B,
#                  lower_diag_B) = dm.initialise_diagonals(r_vals, Nx)
...
#                  main_diag_B,
#                  upper_diag_B,
#                  lower_diag_B) = dm.initialise_diagonals(r_vals, Ny)
#                 A, B = dm.initialise_matrices_var_dif(main_diag_A,
#                                                       upper_diag_A,
#                                                       lower_diag_A,
#                                                       main_diag_B,
...
#         for i in range(len(x)):
#             for j in range(len(y)):
#                 # print(f"diffs[{i},{j},:] = {initial_diffs[i, j, :]}")
#                 temps = full_soln[i, j, :]
...
#                  main_diag_B,
#                  upper_diag_B,
#                  lower_diag_B) = dm.initialise_diagonals(r_vals, Nz)
#                 A, B = dm.initialise_matrices_var_dif(main_diag_A,
#                                                       upper_diag_A,
#                                                       lower_diag_A,
#                                                       main_diag_B,
...
#         # print(solution)
#         filename = f"/home/maeve/Documents/test_results_for_metal_int/orig_func/results_{h}"
#         if h % 1 == 0:
#             # print(f"saving test_{h}")
#             np.save(filename, full_soln)


# def v2_iter_func(initial_temps,
#                  initial_diffs,
#                  location_of_intrusion,
#                  app_diff,
#                  boundary_cond,
...
#                 full_soln[i, j, :] = solution.flatten()
#         # print(solution)
#         filename = f"{folder}results_{h}"
#         if h % save_iter == 0:
#             print(f"saving test_{h}")
#             np.save(filename, full_soln)


# def v3_iter_func(initial_temps,
...
def v4_iter_func(initial_temps,
                 initial_diffs: object,
                 location_of_intrusion,
                 app_diff,
                 boundary_cond,
...
def v5_iter_func(initial_temps,
                 initial_diffs: object,
                 location_of_intrusion,
                 app_diff,
                 boundary_cond,
    ...
    for h in range(1, iterations + 1):
        ...
        # print(solution)
        filename = f"{folder}{fileID}_{h}"
        if h == 3 or h == 48 or h == 96 or h == 120:
            print(f"saving test_{h}")
            np.save(filename, full_soln)


def v6_iter_func(initial_temps,
                 initial_diffs: object,
                 location_of_intrusion,
                 app_diff,
                 boundary_cond,
